# nvim-treesitter-queries-liquidsoap

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-liquidsoap/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-liquidsoap/actions/workflows/validate.yml)

Neovim tree-sitter queries for **liquidsoap**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-liquidsoap",
...
- [ ] Changes are scoped to `liquidsoap` — do not include files for other languages
